...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo "../../Model/registerCaandidate.php?id=$id" ?>" method="post">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="position" name="position" value="<?php echo $candidate['position']; ?>" required>
                <span class="error" id="position-error"></span>
            </div>
            <div class="form-group">
                <label for="qualification">Qualification:</label>
                <textarea id="qualification" name="qualification"
                    required><?php echo $candidate['qualification']; ?></textarea>
